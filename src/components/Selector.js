...
export default class Selector extends Component {
  ...
  constructor(props) {
    ...
    this.state = {iteration: 0, targets: [], hoveringEle: null, mainTarget: null}
  }
  ...
  render() {
    return (
      <div className="" onAnimationEnd={this.handleOnAnimationEnd}>
        <Link to="/project">
          <div className="red-bg selector animated bounce" id="Project" onMouseOver={this.props.expand ? null : this.handleMouseOver} onMouseLeave={this.props.expand ? null :this.handleMouseLeave}>
            <div className="text">
              Project
            </div>
          </div>
        ...
        <a href="https://github.com/daweifeng">
          <div className="blue-bg selector animated bounce delay-025" id="Github" onMouseOver={this.props.expand ? null : this.handleMouseOver} onMouseLeave={this.props.expand ? null :this.handleMouseLeave}>
            <div className="text">
              Github
            </div>
          </div>
        ...
        <div className="orange-bg selector animated bounce delay-05" id="Resume" onMouseOver={this.props.expand ? null : this.handleMouseOver} onMouseLeave={this.props.expand ? null :this.handleMouseLeave}>
          <div className="text">            
              Resume
          </div>
        </div>
